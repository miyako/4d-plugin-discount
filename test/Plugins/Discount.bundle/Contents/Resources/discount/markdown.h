...
extern int mkd_generatehtml(Document *p, std::ostringstream &outstream);
extern int  mkd_css(Document *, char **);
extern int  mkd_generatecss(Document *, FILE *);
extern int  mkd_generatecss(Document *d, std::ostringstream &outstream);

extern int  mkd_generatetoc(Document *p, std::ostringstream &outstream);
...
//extern void mkd_with_html5_tags();
